...
public class Constants {
    ...
    public static final int WIDTH_EXPLOSION = 100;
    public static final int HEIGHT_EXPLOSION = 100;

    public static final String SERVER_URL = "http://192.168.247.1:3000"; //0.0.0.0 not valid
}
